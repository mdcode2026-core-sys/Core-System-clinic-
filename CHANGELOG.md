...
- **Seed migration `20260804000001_inventory_transaction_types.sql`:** replaced generic consumption_type with 6 approved Transaction Types (purchase, purchase_return, doctor_request, unused_return, inventory_adjustment_increase, inventory_adjustment_decrease).
