...
**Status:** IMPLEMENTED — verification workflow hardening
...
The PostgreSQL container is started with conservative memory settings so extension creation and schema replay do not consume excessive runner memory. The workflow remains disposable and isolated.
