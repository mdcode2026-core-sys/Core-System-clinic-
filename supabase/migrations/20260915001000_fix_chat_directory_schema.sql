-- Restore the authoritative Communications schema used by the chat directory.
-- The previous role-column repair accidentally referenced a non-existent
-- participant table and an obsolete conversation lifecycle column.
