...
begin
 ...
 select p_tenant_id,p_item_id,v_procedure_id,p_treatment_plan_item_id,ii.name,p_quantity,'doctor_request',p_reason,p_consumed_by,p_visit_id from inventory_items ii where ii.id=p_item_id and ii.tenant_id=p_tenant_id returning id into v_existing;
