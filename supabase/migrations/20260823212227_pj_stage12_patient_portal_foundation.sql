...
insert into public.entitlements(key, description, entitlement_type) values
 ...
 ('communication.whatsapp','Patient communication by WhatsApp','channel') on conflict (key) do nothing;
insert into public.capabilities(key, description, is_core) values
 ...
 ('communication.whatsapp','Send patient WhatsApp communication',false) on conflict (key) do nothing;
insert into public.entitlement_capabilities(entitlement_key, capability_key) values
 ('patient_portal','patient_portal.access'),('patient_portal','patient_portal.profile'),('patient_portal','patient_portal.appointments'),('patient_portal','patient_portal.medical_files'),
 ('patient_experience.advanced','patient_experience.messaging'),('patient_experience.advanced','patient_experience.forms'),('patient_experience.advanced','patient_experience.consent'),('patient_experience.advanced','patient_experience.uploads'),
 ('communication.email','communication.email'),('communication.sms','communication.sms'),('communication.whatsapp','communication.whatsapp') on conflict do nothing;
