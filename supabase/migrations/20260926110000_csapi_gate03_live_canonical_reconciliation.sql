-- CSAPI Gate 03 live-schema reconciliation.
-- The live database received an out-of-band replay after the original execution
-- reconciliation and its canonical function bodies were subsequently overwritten.
-- This migration restores the exact canonical Gate 03 execution contract without
-- altering the original historical migration.
