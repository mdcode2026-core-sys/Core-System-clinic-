...
values
  ('00000000-0000-0000-0000-00000000d208', '00000000-0000-0000-0000-00000000d202', '00000000-0000-0000-0000-00000000d206', '00000000-0000-0000-0000-00000000d204', false, 'waiting'),
  ('00000000-0000-0000-0000-00000000d209', '00000000-0000-0000-0000-00000000d203', '00000000-0000-0000-0000-00000000d207', '00000000-0000-0000-0000-00000000d205', false, 'waiting');
...
select throws_ok($sql$
  insert into public.clinical_work_sessions (tenant_id, visit_id, sequence_no, status, performed_by_clinic_user_id)
  values ('00000000-0000-0000-0000-00000000d202', '00000000-0000-0000-0000-00000000d208', 2, 'active', '00000000-0000-0000-0000-00000000d204')
$sql$, '23505', null, 'duplicate active Work Session for one Visit is rejected');

select throws_ok($sql$
  insert into public.patient_flow_queue_entries (tenant_id, visit_id, operating_date, lane_key, priority_class, position, created_by_clinic_user_id)
  values ('00000000-0000-0000-0000-00000000d202', '00000000-0000-0000-0000-00000000d208', current_date, 'clinical', 'high', 2, '00000000-0000-0000-0000-00000000d204')
$sql$, '23505', null, 'duplicate active Queue Entry for one Visit is rejected');

select throws_ok($sql$
  insert into public.clinical_work_sessions (tenant_id, visit_id, sequence_no, status, performed_by_clinic_user_id)
  values ('00000000-0000-0000-0000-00000000d202', '00000000-0000-0000-0000-00000000d209', 2, 'active', '00000000-0000-0000-0000-00000000d204')
$sql$, '23503', null, 'Work Session rejects a cross-tenant Visit reference');

select throws_ok($sql$
  insert into public.patient_flow_queue_entries (tenant_id, visit_id, operating_date, lane_key, priority_class, position, created_by_clinic_user_id)
  values ('00000000-0000-0000-0000-00000000d202', '00000000-0000-0000-0000-00000000d209', current_date, 'clinical', 'high', 2, '00000000-0000-0000-0000-00000000d204')
$sql$, '23503', null, 'Queue Entry rejects a cross-tenant Visit reference');

select throws_ok($sql$
  insert into public.patient_flow_events (tenant_id, visit_id, work_session_id, queue_entry_id, event_type, actor_clinic_user_id)
  values ('00000000-0000-0000-0000-00000000d202', '00000000-0000-0000-0000-00000000d208', '00000000-0000-0000-0000-00000000d211', '00000000-0000-0000-0000-00000000d212', 'cross_tenant_test', '00000000-0000-0000-0000-00000000d204')
$sql$, '23503', null, 'Event rejects a cross-tenant Work Session reference');

select throws_ok($sql$
  insert into public.patient_flow_events (tenant_id, visit_id, work_session_id, queue_entry_id, event_type, actor_clinic_user_id)
  values ('00000000-0000-0000-0000-00000000d202', '00000000-0000-0000-0000-00000000d208', '00000000-0000-0000-0000-00000000d210', '00000000-0000-0000-0000-00000000d213', 'cross_tenant_test', '00000000-0000-0000-0000-00000000d204')
