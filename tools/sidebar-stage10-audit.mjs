...
expect(workspaceSurfaces.includes('key: "administration"') && workspaceSurfaces.includes('href: "/administration"') && workspaceSurfaces.includes("implemented: true"), "Administration Workspace must be a canonical implemented surface");
...
console.log("Operational quick actions are scoped to Operations, while permissions remain independent of Workspace assignment.");
