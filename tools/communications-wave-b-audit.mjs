...
const checks = [
  ["Global Chat is implemented as a surface over Communications", chat.includes('from "@/domain/communications/communications.actions"') && chat.includes("createConversation") && actions.includes('rpc("create_communication_conversation"')],
