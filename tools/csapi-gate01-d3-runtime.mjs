...
try {
  ...
  await expectText("Clinical Visit|Visit Context|Examination", "clinical work surface");
  ...
  await expectText("Pending|Returned|Reception", "pending close returned-to-reception state");
