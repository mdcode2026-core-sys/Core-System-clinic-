/**
 * Compatibility map for existing UI components that still contain literal Arabic.
 * New UI must use message keys; this map keeps the current application bilingual
 * while those legacy literals are migrated incrementally.
 */
export const legacyArabicToEnglish: Record<string, string> = {
  "إدارة المواعيد والجدولة": "Appointment and scheduling management",
  ...
  "مجدول": "Scheduled",
  "مؤكد": "Confirmed",
  "في الجلسة": "In session",
  "مكتمل": "Completed",
  "التقويم الأسبوعي": "Weekly Calendar",
  "tenant_id:": "tenant_id:",
  "user_id:": "user_id:",
  "auth_loading:": "auth_loading:",
  "عدد المرضى:": "Patient count:",
  "عدد الأطباء:": "Doctor count:",
  "عدد الغرف:": "Room count:",
  "عدد الإجراءات:": "Procedure count:",
  "خطأ المرضى:": "Patient error:",
  "خطأ المواعيد:": "Appointment error:",
  "عدد المواعيد:": "Appointment count:",
  ...
  "لا يوجد": "None",
  "لا يوجد شيء": "Nothing found",
  "لم يتم العثور على النتائج": "No results found",
  "لم يتم العثور على المريض": "Patient not found",
  "لا يوجد مرضى": "No patients",
  "لا يوجد مرضى في الطابور": "No patients in the queue",
  ...
  "تكبير": "Zoom in",
  "تدوير": "Rotate",
  "تدوير لليمين": "Rotate right",
  "إعادة ضبط": "Reset",
  "ربط بالمريض": "Assign to Patient",
  "المريض": "Patient",
  "الزيارة": "Visit",
  "الطبيب": "Doctor",
  "الغرفة": "Room",
  ...
  "المتابعة": "Follow-up",
  "لا توجد عناصر متابعة": "No follow-up items",
  "إضافة متابعة": "Add follow-up",
  "لوحة التحكم": "Dashboard",
  "نظرة عامة": "Overview",
  "مرحباً": "Welcome",
  "خطط العلاج": "Treatment Plans",
  "إضافة خطة علاج": "Add Treatment Plan",
  "لا توجد خطط علاج": "No treatment plans",
  "تسجيل الدخول": "Login",
  "التسجيل": "Register",
  ...
  "العربية": "Arabic",
  "الإنجليزية": "English",
  "المساحة الطبية": "Clinical Workspace",
  "مساحة العمل": "Workspace",
  "مساحة التشغيل": "Operation Workspace",
  "الأجندة": "Agenda",
  "المرضى": "Patients",
  "الفواتير": "Invoices",
  "التحليلات": "Analytics",
  ...
  "الهاتف الثانوي": "Secondary phone",
  ...
  "تعديل مريض": "Edit Patient",
  "تفاصيل المريض": "Patient Details",
  "حجز موعد": "Book Appointment",
  "تسجيل في الطابور": "Check in to Queue",
  "تسجيل حضور": "Check in"
};
