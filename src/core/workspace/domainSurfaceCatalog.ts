...
export const DOMAIN_SURFACE_CATALOG: readonly DomainSurfaceDecision[] = [
  ...
  { domain: "Patient Flow", surface: "contextual", widget: "yes", widgetRationale: "Patient Flow remains a contextual orchestration layer, while an authorized Widget exposes flow exceptions and items requiring administrative attention; the Widget does not turn Patient Flow into a standalone Sidebar module.", quickAction: "yes" },
