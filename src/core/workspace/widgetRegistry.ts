...
export const widgetRegistry: WidgetDefinition[] = [
  ...
  { key: "medical-files", label: "Medical Files", labelAr: "الملفات الطبية", category: "interactive", layer: 2, defaultSize: { width: "full", height: "tall" }, requiredPermission: "medical_files:read", moduleKey: "medical_files", component: MedicalFilesWidget, defaultWorkspaces: ["administrative", "clinical"], contextual: true },
