...
import { LayoutDashboard, Users, CalendarDays, FileText, FileBarChart, BarChart3, PhoneCall, BriefcaseBusiness, Stethoscope, ClipboardList, CreditCard, WalletCards, ShieldCheck, Boxes, ShoppingCart, MessageCircle, ListChecks } from "lucide-react";
import type { LucideIcon } from "lucide-react";

export type NavigationLabelKey=keyof typeof messages.en.nav;export type NavigationLabel={ar:string;en:string};export interface NavItem{href:string;labelKey:NavigationLabelKey|null;label?:NavigationLabel;icon:LucideIcon;requiredPermission:Permission|null;capabilityKey?:string;children?:NavItem[];navigationOnly?:boolean;}
...
/** Patient Flow is intentionally absent: it is an internal workflow, not an ordinary Sidebar Module/Domain. */
...
export function getSidebarNavigation(){return navigationRegistry;}
