...
const financialResourcesChildren: NavItem[] = [
  ...
  { href: "/financial-resources?section=financial-plans", label: { ar: "الخطط المالية", en: "Financial Plans" }, labelKey: null, icon: WalletCards, requiredPermission: "invoices:read", capabilityKey: "financial_resources.financial_plans", surface: "core", children: [
    { href: "/financial-resources?section=installments", label: { ar: "الأقساط", en: "Installments" }, labelKey: null, icon: ClipboardList, requiredPermission: "invoices:read", capabilityKey: "financial_resources.installments", surface: "core" },
  ] },
  { href: "/financial-resources?section=insurance", label: { ar: "التأمين", en: "Insurance" }, labelKey: null, icon: ShieldCheck, requiredPermission: "insurance:read", capabilityKey: "financial_resources.insurance", surface: "core", children: [
    { href: "/insurance/claims", label: { ar: "المطالبات", en: "Claims" }, labelKey: null, icon: ClipboardCheck, requiredPermission: "insurance:read", capabilityKey: "financial_resources.insurance.claims", surface: "core" },
  ] },
  { href: "/inventory", label: { ar: "المخزون", en: "Inventory" }, labelKey: null, icon: Boxes, requiredPermission: "inventory:read", capabilityKey: "financial_resources.inventory", surface: "core", children: [
    { href: "/financial-resources?section=consumption", label: { ar: "الاستهلاك", en: "Consumption" }, labelKey: null, icon: ClipboardCheck, requiredPermission: "inventory:read", capabilityKey: "financial_resources.consumption", surface: "core" },
  ] },
  { href: "/financial-resources?section=purchasing", label: { ar: "المشتريات", en: "Purchasing" }, labelKey: null, icon: ShoppingCart, requiredPermission: "purchasing:read", capabilityKey: "financial_resources.purchasing", surface: "core", children: [
    { href: "/financial-resources?section=suppliers", label: { ar: "الموردون", en: "Suppliers" }, labelKey: null, icon: Truck, requiredPermission: "purchasing:read", capabilityKey: "financial_resources.suppliers", surface: "core" },
    { href: "/financial-resources?section=receiving", label: { ar: "الاستلام", en: "Receiving" }, labelKey: null, icon: ClipboardCheck, requiredPermission: "purchasing:read", capabilityKey: "financial_resources.receiving", surface: "core" },
  ] },
];
