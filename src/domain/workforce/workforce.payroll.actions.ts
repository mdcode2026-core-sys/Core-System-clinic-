...
export async function createPayrollEntryFromWorkforce(input: { payroll_period_id: string; employee_id: string; allowances_subunits?: number; overtime_subunits?: number; bonuses_subunits?: number; deductions_subunits?: number; }) {
