  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-muted-foreground">
        تم دمج إدارة قوالب الأدوار في قسم <span className="font-medium text-foreground">&quot;الأدوار&quot;</span>.
...
function OverridesTab() { return <OverridesManager />; }
function NotificationsTab() { return <NotificationsManager />; }
function SubscriptionTab() { return <SubscriptionCenter />; }
function AuditTab() { return <AuditLogManager />; }
function ProceduresTab() { return <ProceduresManager />; }
function SystemPreferencesTab() { return <SystemPreferencesManager />; }
