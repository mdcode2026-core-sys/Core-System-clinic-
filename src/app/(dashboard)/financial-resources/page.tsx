...
export default async function FinancialResourcesPage(){
 ...
 const [tenant,patients,invoices,items,suppliers,providers,contracts,bills,expenses,profiles,claims]=await Promise.all([
