  ...
  return (
    <Card className="cs-surface-raised mx-auto w-full max-w-md rounded-2xl border-[var(--cs-slate-200)] bg-white" dir={locale === "ar" ? "rtl" : "ltr"}>
      <CardHeader className="space-y-5 p-6 pb-4 text-center sm:p-8 sm:pb-5">
        <div className="mx-auto flex h-12 w-full max-w-[11rem] items-center justify-center sm:h-14">
          <Image src="/brand/clinicsaas-header.svg" alt="ClinicSaaS™" width={190} height={42} priority className="h-auto w-full max-w-[11rem]" />
        </div>
        <div>
