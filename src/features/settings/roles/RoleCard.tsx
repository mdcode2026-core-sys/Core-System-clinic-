...
export function RoleCard({ role, permissions, onEditPermissions, onEditMetadata, onDelete, canManage }: RoleCardProps) {
  const { locale, admin: a, roles: t } = useI18n();
