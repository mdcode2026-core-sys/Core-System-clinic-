...
export function CommunicationsHeaderControl({ isArabic }: CommunicationsHeaderControlProps) {
  ...
  return (
    <div className="relative">
      ...
      {open ? <div role="dialog" aria-label={isArabic ? "تنبيهات وملاحظات الاتصالات" : "Communications alerts and notes"} className="fixed inset-x-2 top-[4.25rem] z-[80] w-auto max-w-[calc(100vw-1rem)] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl md:absolute md:inset-x-auto md:end-0 md:top-11 md:w-[22rem] md:max-w-[calc(100vw-1.5rem)]">
