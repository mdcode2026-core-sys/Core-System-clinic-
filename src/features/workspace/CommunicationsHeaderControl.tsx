...
export function CommunicationsHeaderControl({ isArabic }: CommunicationsHeaderControlProps) {
  ...
  return (
    <div className="relative">
      ...
      <GlobalOverlayPortal open={open} anchorRef={triggerRef} onClose={closeUtility} id="global-communications-panel" ariaLabel={isArabic ? "تنبيهات وملاحظات الاتصالات" : "Communications alerts and notes"} dir={isArabic ? "rtl" : "ltr"} role="dialog" width={352}>
        <div data-testid="global-communications-panel" className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl">
