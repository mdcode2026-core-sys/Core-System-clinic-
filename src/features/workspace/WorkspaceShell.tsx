...
export function WorkspaceShell({ children, user }: WorkspaceShellProps) {
  ...
  return <div className="flex h-screen w-full bg-gray-50">
    ...
    <aside style={{ transform: sidebarTransform }} className={cn("fixed inset-y-0 start-0 z-50 w-64 transform bg-white shadow-lg transition-transform duration-200 ease-in-out lg:static lg:translate-x-0")}>
