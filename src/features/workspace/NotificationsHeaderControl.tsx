...
export function NotificationsHeaderControl({ isArabic }: NotificationsHeaderControlProps) {
  ...
  return <div className="relative">
    ...
    {open && <section role="dialog" aria-label={isArabic ? "الإشعارات" : "Notifications"} className={cn("fixed inset-x-2 top-[4.25rem] z-[80] w-auto max-w-[calc(100vw-1rem)] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl", "md:absolute md:inset-x-auto md:top-11 md:w-[23rem] md:max-w-[calc(100vw-1.5rem)]", isArabic ? "md:start-0" : "md:end-0")} data-testid="notifications-header-panel">
